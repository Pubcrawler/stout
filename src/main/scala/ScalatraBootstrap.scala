...
import io.pubcrawler.stout.controllers.{CrawlController, ProfileController, StoutSwagger, StopController, SwaggerController}
...
class ScalatraBootstrap extends LifeCycle with LazyLogging with DbConnection {
  ...
  override def init(context: ServletContext) {
    ...
    context.mount(new StopController, "/stop/*")
